...
import com.gomezrondon.awsexamgenerator.configuration.ConfigApplication
import com.gomezrondon.awsexamgenerator.service.GenerateQuestionService
import com.gomezrondon.awsexamgenerator.service.Question
import java.io.File
...
private fun mainProcess(prfijo:String="") {
    ...
    // there is no DI
    val levelsOfDifficulty = ConfigApplication().getLevelOfDifficulty()

    val service = GenerateQuestionService(levelsOfDifficulty)
