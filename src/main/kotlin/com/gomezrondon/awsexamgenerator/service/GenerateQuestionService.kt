package com.gomezrondon.awsexamgenerator.service
...
@Service
class GenerateQuestionService(val levelsOfDifficulty:List<List<questionContext>>){
    ...
    fun generateQuestions(questionsList: List<Question>, questionsfileName: String, answerfileName: String, keepOrder:Boolean=true): String {
        ...
        """.trimIndent()
            ...
            getPercentageListOfQuestions(numberOption.toInt(), percentageList, questionsList).toMutableList()
        } else {
             generateQuestion(questionsList as MutableList<Question>, numberOption.toInt());
        }


        val responses =  askQuestions(questions)
        val results =  evaluateResults(questions, responses, keepOrder)
